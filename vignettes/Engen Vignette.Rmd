...
Included in this package is the mon_gen dataset. Due to the nature of the government generated dataset, the values for Installed Capacity and Net Generation must first be converted from factors to numeric values prior to use. The lines of code below will acheive this.
```
...
####Usage
```
mon_gen_mo <- mo_engen(mon_gen, "Installed.Capacity..kW.", "Monthly.Nameplate", "Net.Generation..kWh.", "Percent.Generation")
```
...
####Usage
```
mon_gen_mo_gr <- mo_engen_gr(mon_gen_mo, "Plant.Name", "Alcova", "Percent.Generation", "Month", "Year")
```
...
|    month   |  THe numeric column containing the month corresponding to each data point                          |
...
|  Parameter | Information                                                                                        |
|-----------:|:---------------------------------------------------------------------------------------------------|
|     df     |  The data frame to be used in this function, ideally having already passed through yr_engen        |
|    year    |  The numeric column containing the year corresponding to the data in order properly group the data |
|    para    |  The numeric column containing the parameter you wish to calculate the yearly mean of              |

####Usage
```
mon_gen_yr_gr <- yr_engen_gr(mon_gen_yr, "Year", "Percent.Generation")
```